...
architecture RTL of testbench is
    ...
    signal enable_gen_s : std_logic := '0';
    signal ready_gen_s   : std_logic;
...
begin
    ...
    stimulus: process begin
        ...
        enable_gen_s <= '1';             --Start the generation phase
     
        wait for 80 ns;     
     
        enable_gen_s <= '0';

        wait until ready_gen_s = '1';    --Wait until the generation finishes    
