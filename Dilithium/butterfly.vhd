...
architecture RTL of butterfly is
  ...
  signal dsp_in_a_s             : unsigned(31 downto 0);
  signal dsp_in_b_s             : unsigned(31 downto 0);
  signal dsp_out_s              : unsigned(63 downto 0);
...
begin
  ...
  dsp_out_s <= dsp_in_a_s * dsp_in_b_s;
  
  combinatorial : process (ram_out.q_a, ram_out.q_b, offset, address, zeta, NTT_INTT_Select, montgomeryReducerOut_s, MONT_Mode, dsp_out_s)
  ...
  begin
    ...
    case NTT_INTT_Select is  
      when '0' => --NTT
        ...
        dsp_in_a_s <= unsigned(ram_out.q_b);

        dsp_in_b_s <= unsigned(zeta);

        --Calculate Montgomery as soon as memory is ready
        montgomeryReducerIn_s <= dsp_out_s;
      ...
      when '1' => --INTT
        ...
        case MONT_Mode is
          when '0' => --Standard INTT calculation
            ...
            dsp_in_a_s <= (unsigned(ram_out.q_a) + Q256_v - unsigned(ram_out.q_b));
          ...
          when '1' => --Unique to the last loop of the INTT
            ...
            dsp_in_a_s <= unsigned(ram_out.q_a);
