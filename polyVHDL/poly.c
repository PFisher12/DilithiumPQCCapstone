...
* Name:        poly_ntt
* 
* Description: Forward NTT, in-place
*
* Arguments:   - poly *a: pointer to inpout/output polynomial
**************************************************/
...
* 
* Description: Inverse NTT and multiplication with 2^{32}, in-place.
*
* Arguments:   - poly *a: pointer to input/output polynomial
**************************************************/
...
/*****************************************************************************
 * ---------------------------------------------WORK ON REJ AND THE FUNCTION BELOW IT---------------------------------------------------
 */
